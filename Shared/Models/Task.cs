...
namespace Shared.Models
{
    ...
    public class Task
    {
        ...
        public Task()
        {
            TargetDate = ShamsiDateHelper.GetCurrentShamsiDate();
                   ...
                   double estimatedHours = 1.0, string? targetDate = null)
        {
            ...
            TargetDate = targetDate ?? ShamsiDateHelper.GetCurrentShamsiDate();
        ...
        public bool StartTask()
        {
            if (Status == TaskStatus.Pending)
            {
                ...
                StartDate = ShamsiDateHelper.GetCurrentShamsiDate();
                UpdatedAt = DateTime.Now;
                return true;
            }
            return false;
        ...
        public bool CompleteTask(double? actualHours = null, string notes = "")
        {
            if (Status == TaskStatus.InProgress)
            {
                ...
                CompletionDate = ShamsiDateHelper.GetCurrentShamsiDate();
        ...
        [JsonIgnore]
        public string TargetDateDisplay => ShamsiDateHelper.FormatForDisplay(TargetDate);

        [JsonIgnore]
        public string StartDateDisplay => string.IsNullOrEmpty(StartDate) ? "" : ShamsiDateHelper.FormatForDisplay(StartDate);

        [JsonIgnore]
        public string CompletionDateDisplay => string.IsNullOrEmpty(CompletionDate) ? "" : ShamsiDateHelper.FormatForDisplay(CompletionDate);

        [JsonIgnore]
        public string TargetDateGregorian => ShamsiDateHelper.ShamsiToGregorian(TargetDate);
